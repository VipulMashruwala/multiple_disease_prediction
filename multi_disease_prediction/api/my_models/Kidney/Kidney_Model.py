...
class Custom_Model_Kidney():
    ...
    def model_predict(self,X_test):
        ...
        result =  np.array([predict_rf,predict_tree,predict_abc])
    ...
    def model_predict_proba(self, X_test):
        ...
        predict_proba_list = [predict_tree_proba,predict_rf_proba,predict_abc_proba]
        ...
        return (zero_proba)/3, (one_proba)/3
